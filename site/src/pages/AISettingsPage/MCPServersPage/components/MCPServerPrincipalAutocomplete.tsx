	...
	return (
		<div className="flex flex-col gap-2">
			<Autocomplete
				...
				placeholder={tI18n(
					"AISettingsPage.MCPServersPage.components.MCPServerPrincipalAutocomplete.search_for_user_or_group_0aa07b31",
				)}
				noOptionsText={
					aclAvailableQuery.error
						? tI18n(
								"AISettingsPage.MCPServersPage.components.MCPServerPrincipalAutocomplete.unable_to_load_users_or_groups_4b1be748",
							)
						: tI18n(
								"AISettingsPage.MCPServersPage.components.MCPServerPrincipalAutocomplete.no_users_or_groups_found_02da3b9f",
							)
				}
				className={className}
				id={autocompleteId}
